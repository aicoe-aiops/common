...
based on the [labels.yaml](https://github.com/aicoe-aiops/common/blob/master/labels.yaml) that it uses to
sync GitHub labels across repos in the [AICoE AIOps GitHub org](https://github.com/aicoe-aiops)
...
- Open a PR, _with a single commit_, that:
  - updates [labels.yaml](https://github.com/aicoe-aiops/common/blob/master/labels.yaml) with the new label(s)
...
| ---- | ----------- | -------- | --- |
| <a id="deprecated" href="#deprecated">`deprecated`</a> | This is a set of deprecated labels, they will be removed <br><br> This was previously `sig/devops`, `sig/docs`, `sig/pipelines`, `sig/cyborgs`, `sig/documentation`, `sig/build`, `deployment_name/ocp4-test`, `deployment_name/ocp4-stage`, | anyone |  [label](https://git.k8s.io/test-infra/prow/plugins/label) |
